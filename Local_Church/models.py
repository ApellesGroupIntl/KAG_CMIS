...
class Report(models.Model):
    ...
    mission_offerings = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    plot_contributions = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    big_days_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    big_days_details = models.TextField(blank=True, null=True)
    mission_support = models.DecimalField(max_digits=10, decimal_places=2, default=0)
